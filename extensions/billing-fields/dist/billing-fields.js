...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/billing-fields/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    const [ragSoc, setRs] = (0, import_react15.useState)("");
    const [pIva, setpIva] = (0, import_react15.useState)("");
    const [pec, setPec] = (0, import_react15.useState)("");
    const [codSDI, setSdi] = (0, import_react15.useState)("");
    const [fiscale, setFiscale] = (0, import_react15.useState)("");
    const [ragSocValidationError, setRagSocValidationError] = (0, import_react15.useState)("");
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if (canBlockProgress2 && !ispIvaset()) {
        return {
          behavior: "block",
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if (canBlockProgress2 && !isPECset()) {
        return {
          behavior: "block",
          reason: "PEC is required",
          perform: (result) => {
            if (result.behavior === "block") {
              setPecValidationError("L'indirizzo email fornito non \xE8 valido.");
            }
          }
        };
      }
    ...
    useBuyerJourneyIntercept(({ canBlockProgress: canBlockProgress2 }) => {
      if (canBlockProgress2 && !isFiscale()) {
        return {
          behavior: "block",
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
      Form2,
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Grid2, { columns: ["fill"], spacing: "base", children: [
